...
Feature: Purchase Products
  ...
  Scenario Outline:Test4 Add Products to Cart and Place Order
    Given I am on the shopping website
    And I search for "<product>" and "<categories>" and add it to the cart
    And I proceed to the cart
    And I should see the "<product>" in the shop cart
    And I proceed to the cart
    When I place the order with "<name>" and "<country>" and "<city>"  and "<creditCard>"  and "<month>" and "<year>"
    ...
    Examples:
      | product |  categories  | name          | country         | city   | creditCard        | month   | year  |       message                |
      | Samsung galaxy s6,Nokia lumia 1520,ony vaio i7,ASUS Full HD        |   Phones,Laptops,Monitors              | Jhon          | United States   | Miami  | 1234 5678 9012 34 |   12    | 2023  | Thank you for your purchase! |
